...
El repositorio oficial de SerenityOS utiliza múltiples lenguajes. De acuerdo con las estadísticas de lenguajes publicadas por GitHub (endpoint \texttt{https://api.github.com/repos/SerenityOS/serenity/languages}), el volumen principal del código está en C++ y, en menor proporción, en otros lenguajes usados para subsistemas, tooling y automatización. En los valores reportados (en bytes) se observan, entre otros:
...
Para desarrollo de código, SerenityOS no impone un IDE único: es posible trabajar con editores como Vim, Emacs o entornos gráficos. Para el proyecto se utilizará Visual Studio Code.
